"""
Functions to convert Honeybee Model to RadiativeSurface objects for VF computation
"""
...
def generate_radiative_surface_objects_from_hb_model(hb_model: Model, include_windows: bool = True) -> \
        (List[RadiativeSurface], List[str]):
    """ todo """
    ...
    for surface in hb_face_and_aperture_list:
        ...
        surface_id_list.append(surface.identifier)

    return radiative_surface_object_list, surface_id_list
