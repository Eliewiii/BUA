...
# Example usage:
radar = RadarChart()
radar.add_axis("EROI", None, 2.5, 4, "value", order="ascending")
radar.add_axis("GHGEI", "gCO2eq/kWh", 70, 120, "value", order="descending")
...
# Balanced
radar.add_data([3.43, 78.5, 1.64, 63, 2.54, 35], color="cornflowerblue", label=" c-Si Low")
radar.add_data([3.34, 81.1, 1.62, 35, 2.80, 35], color="mediumseagreen", label=" c-Si Medium")
radar.add_data([3.08, 89.3, 1.53, 30.3, 3.62, 37], color="lightcoral", label=" c-Si High")


# Production
radar.add_data([2.81, 98.7, 1.43, 68, 2.75, 41], color="cyan", label=" c-Si Low")
radar.add_data([2.73, 102, 1.41, 37, 3.02, 42], color="limegreen", label=" c-Si Medium")
radar.add_data([2.51, 112, 1.34, 32.9, 3.92, 44], color="magenta", label=" c-Si High")
# # Add data
# radar.add_data([3.56, 74.9, 1.66, 58, 2.36, 32], color="blue", label=" c-Si Low")
# radar.add_data([3.49, 77.0, 1.65, 32.1, 2.57, 33], color="green", label=" c-Si Medium")
# radar.add_data([3.19, 85.5, 1.55, 27.9, 3.33, 35], color="red", label=" c-Si High")
